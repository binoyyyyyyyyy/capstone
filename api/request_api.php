...
switch ($method) {
    ...
    case 'POST': // Create a new request
        ...
        $stmt = $conn->prepare("INSERT INTO RequestTable (requestCode, documentID, userID, studentID, dateRequest, datePickUp, requestStatus, dateCreated) VALUES (?, ?, ?, ?, NOW(), ?, 'pending', NOW())");
