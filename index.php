    ...
    <section class="hero-section">
        <div class="container text-center">
            ...
            <div class="d-flex justify-content-center gap-3">
                <a href="admin/request_form.php" class="btn btn-warning btn-lg px-4"><i class="fas fa-plus-circle me-2"></i>Create Request</a>
                <a href="admin/my_request.php" class="btn btn-outline-light btn-lg px-4"><i class="fas fa-list me-2"></i>View Requests</a>
            </div>
        </div>
    </section>
            ...
            <div class="col-lg-6 mb-4">
                <div class="p-4 bg-white rounded-3 shadow-sm h-100">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="https://scontent.fmnl8-1.fna.fbcdn.net/v/t39.30808-6/533009340_1268972105017393_542645206682030523_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=f727a1&_nc_ohc=-wzQ9jEsEUAQ7kNvwHPhRUS&_nc_oc=AdkcszbHIpE71Vg_DTdOmNLP59gxww2LbdgNEFREq6frxswu9Ie5NBqWST3wS-N4sOY&_nc_zt=23&_nc_ht=scontent.fmnl8-1.fna&_nc_gid=YPVz5wlhUBMFlda8E5baRw&oh=00_AfXBhkBLK6jUWq7mzijTZu3AghXvwMyp4gJIW_FkDVP7bA&oe=68AC289D" class="text-decoration-none"><i class="fas fa-arrow-right text-primary me-2"></i> Academic Calendar</a></li>
